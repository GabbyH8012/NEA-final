...
def filter():
    ...
    if race_IDs != []:
        ...
        for race_id in race_IDs:
            ...
            if "S" in courses and "L" not in courses:
                selected_race_names.append(find_race_from_ID(int(race_id)))

            elif "L" in courses and "S" not in courses:
...
# add Target competition handler
# --------------------
@manualDataEntry_bp.route("/addTargetComp", methods=['GET', 'POST'])
def addTargetComp():
